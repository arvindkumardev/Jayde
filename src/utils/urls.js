...
const RECYCLER_CONFIRM_SCHEDULE = `/api/mobile/recycler/reScheduleConfirm`;
...
export {
     SUB_USER, ADD_SUB_USER, LOGIN_URL, SIGN_UP, PROFILE_UPDATE, BUSINESS_UPDATE, GETBUSINESS_PROFILE, FORGOT_PASSWORD, GET_SUB_CATEGORY, GET_UNITS, CREATE_QUOTE_PAPER, CREATE_QUOTE_PLASTIC, CREATE_QUOTE_MIX_WASTER, USERS, GET_CATEGORIES,
     IMAGE_UPLOAD, ENABLE_USER, DISABLE_USER, ADMIN_NEW_ORDER, ACCEPT_ORDER, REJECT_ORDER,
     GET_AGGREGATORS, GET_RECYCLERS, RECYCLER_SWO_TO_AGGREGATOR, RECYCLER_SWO_TO_RECYCLER,
     RECYCLER_SCHEDULE_ORDER_LIST, RECYCLER_WORK_ORDER_LIST, RECYCLER_COMPLETED_ORDER_LIST,
     ASSIGN_AGGREGATOR, AGGREGATOR_NEWORDER, RECYCLER_REJECT_ORDER, RECYCLER_CONFIRM_SCHEDULE,
     ...
     RECYCLER_SCHEDULE_ORDER_DETAIL, RECYCLER_ADD_RECEIPT_DATA,

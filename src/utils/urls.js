...
const AGGREGATORS_CONFIRM_SCHEDULE = `/api/mobile/aggregator/confirm`;
...
const RECYCLER_CONFIRM_SCHEDULE = `/api/mobile/recycler/confirm`;
...
export {
     ...
     CREATE_QUOTE_MIX_WASTER, USERS, GET_CATEGORIES,
     IMAGE_UPLOAD, ENABLE_USER, DISABLE_USER, ADMIN_NEW_ORDER, ACCEPT_ORDER, REJECT_ORDER,
     GET_AGGREGATORS, AGGREGATORS_CONFIRM_SCHEDULE, RECYCLER_CONFIRM_SCHEDULE, GET_RECYCLERS, RECYCLER_SWO_TO_AGGREGATOR, RECYCLER_SWO_TO_RECYCLER,
     RECYCLER_SCHEDULE_ORDER_LIST, RECYCLER_WORK_ORDER_LIST, RECYCLER_COMPLETED_ORDER_LIST,
     ASSIGN_AGGREGATOR, AGGREGATOR_NEWORDER, RECYCLER_REJECT_ORDER, RECYCLER_CONFIRM_RESCHEDULE,

...
const BUSINESS_EPR_PARTNER = `/api/mobile/business/businessEprPartner`;
const BUSINESS_EPR_AGGREGATOR = `/api/mobile/business/businessEprAggregator`;
const IS_PROFILE_COMPLETE = `/api/mobile/business/isProfileComplete`;
...
const EPR_AGGREGATOR = `/api/mobile/admin/eprAggregators`;
...
export {
     ...
     BUSINESS_EPR_PARTNER, BUSINESS_EPR_AGGREGATOR, IS_PROFILE_COMPLETE,
     ...
     IMAGE_UPLOAD, ENABLE_USER, DISABLE_USER, ADMIN_NEW_ORDER, ACCEPT_ORDER, REJECT_ORDER, ADD_SUBCATEGORY, LIST_SUBCATEGORY, DELETE_SUBCATEGORY, EPR_LIST, EPR_AGGREGATOR, ADDEPR_AGGREGATOR, REMOVEEPR_AGGREGATOR,

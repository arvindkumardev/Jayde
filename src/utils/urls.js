...
const AGGREGATOR_CREATE_ORDER = `/api/mobile/aggregator/newWorkOrder`;
...
export {SUB_USER, ADD_SUB_USER, LOGIN_URL, GET_SUB_CATEGORY, GET_UNITS, CREATE_QUOTE_PAPER, CREATE_QUOTE_PLASTIC, CREATE_QUOTE_MIX_WASTER, USERS, GET_CATEGORIES,
     ...
     GET_AGGREGATOR_INVENTORY, AGGREGATOR_CREATE_ORDER, AGGREGATOR_WORK_ORDER_LIST,

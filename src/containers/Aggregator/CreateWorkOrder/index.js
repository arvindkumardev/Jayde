...
function NewWorkOrder() {
  ...
  useEffect(() => {
    if (aggregatorsData) {
      const itemData = aggregatorsData.filter((item) => item.name != userName);
  ...
  useEffect(() => {
    if (recyclersData) {
      const itemData = recyclersData.filter((item) => item.name != userName);
      const pickerData = itemData.map((item) => ({ label: item.name, value: item.id }));
  ...
  const validationSchema = Yup.object().shape({
    ...
    price: Yup.string().test('price', 'Please provide valid price', (value) => isValidVolume(value)),
  });
    ...
    <KeyboardAwareScrollView>
      <View style={Styles.topView}>
        <View style={[AppStyle.ml20, AppStyle.mr20]}>
          <Text style={[Appstyles.txtBlackBold, Appstyles.f17, AppStyle.mt30, Appstyles.textalig]}>
          ...
          {viewType == 1 ? (
            <View style={[AppStyles.mt20]}>
              ...
              />
              {clickConfirm && requestForm.errors.assignTo && (
          ...
          <View style={[AppStyles.mt20]}>
            ...
            />
            {clickConfirm && requestForm.errors.vehicleNo && (
              <CustomText fontSize={15} color={Colors.red} styling={{ marginTop: RfH(10) }}>
          ...
          <View style={[AppStyles.mt20]}>
            <View style={{ flexDirection: 'row' }}>
              ...
              <View style={AppStyles.flexpointfive}>
                <Text style={[AppStyles.txtBlackRegular, AppStyles.f16, AppStyles.mb10, AppStyles.ml5]}>
                  Add Vehicle Image
                </Text>
              </View>
            </View>
            <View style={{ flexDirection: 'row' }}>
              <View style={[AppStyles.flexpointfive, AppStyles.pr10]}>
                <TouchableOpacity
                  ...
                  <Text style={[[AppStyles.txtBlackRegular, AppStyles.f16, AppStyles.pl20]]}>
              ...
              <View style={AppStyles.flexpointfive}>
                <TouchableOpacity
                  style={[Styles.inputIcon, AppStyles.br10]}
                  onPress={() => setImageUpload(!imageUpload)}>
                  <Text
                    style={[
                      AppStyles.txtSecandaryRegular,
                      { color: imgData.length > 0 ? Colors.green : Colors.warmGrey },
                    ]}>
                    {imgData.length > 0 ? 'File Attached' : 'Upload file'}
                  </Text>
            ...
            <View style={{ flexDirection: 'row' }}>
              <View style={{ flex: 0.6, paddingRight: 10 }}>
                <TextInput
                  ...
                  style={AppStyles.inputTxtStyle}
                />
                {clickConfirm && requestForm.errors.price && (
                  <CustomText fontSize={15} color={Colors.red} styling={{ marginTop: RfH(10) }}>
              ...
              <View style={AppStyles.flexpointfour}>
                <DropDown
                  ...
                  containerStyle={AppStyles.inputTxtStyle}
                />
                {clickConfirm && requestForm.errors.priceUnit && (
                  <CustomText fontSize={15} color={Colors.red} styling={{ marginTop: RfH(10) }}>
        ...
        <View style={Styles.btnContainer}>
          <TouchableOpacity style={Styles.confirmbtn} onPress={() => handelSave()}>

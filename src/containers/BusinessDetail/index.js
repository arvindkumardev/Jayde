...
function BusinessDetail() {
  ...
  const businessForm = useFormik({
    ...
    validationSchema,
    onSubmit: () => confirmBusinessUpdate(
       ...
       <ScrollView>
        ...
        <View>
          ...
          <View style={[AppStyles.mt30, AppStyles.ml24, AppStyles.mr24]}>
            ...
            <View>
            <TextInput placeholder={"Business Name"} style={Styles.inputText} 
                 value={businessForm.values.businessname}
                // value={item.business_name}
                onChangeText={(txt) =>
                  businessForm.setFieldValue('businessname', txt)
                }/>
          ...
          <View style={[AppStyles.mt20, AppStyles.ml24, AppStyles.mr24]}>
            ...
            <TextInput placeholder={"Address"} style={Styles.inputText} 
              ...
              onChangeText={(txt) =>
                businessForm.setFieldValue('address', txt)
              }/>
          ...
          <TextInput placeholder={"Hyderabad"} style={Styles.inputTextcity} 
            ...
            onChangeText={(txt) =>
              businessForm.setFieldValue('city', txt)
            }/>
          ...
          <TextInput placeholder={"110004"} style={Styles.inputTextcity} 
              keyboardType={'numeric'}
              value={businessForm.values.pincode}
              onChangeText={(txt) =>
                businessForm.setFieldValue('pincode', txt)
              }/>
        ...
        <View style={[AppStyles.mt20, AppStyles.ml24, AppStyles.mr24]}>
            ...
            <TextInput placeholder={"GST Details"} style={Styles.inputText} 
              value={businessForm.values.gstin}
              onChangeText={(txt) =>
                businessForm.setFieldValue('gstin', txt)
              }/>
          ...
          <View style={[AppStyles.mt20, AppStyles.ml24, AppStyles.mr24]}>
            ...
            <TextInput placeholder={"Pan Number"} style={Styles.inputText} 
            value={businessForm.values.pan}
            onChangeText={(txt) =>
              businessForm.setFieldValue('pan', txt)
              } />
          ...
          <View>
            ...
            <Checkbox
                        ...
                        onValueChange={(newValue) =>
                          businessForm.setFieldValue('checkcondition', newValue)
                        }
                    />
        ...
        <View style={AppStyles.flex1}>
       <TouchableOpacity
           style={[Styles.confirmbtn, AppStyles.mb20]} onPress={() => handleBusinessUpdate()}>

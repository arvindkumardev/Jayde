...
function OwnedContracts() {
  ...
  const _RenderItem = (index, item) => {
    ...
    return (
      ...
      <Text style={[AppStyles.f13, AppStyles.txtSecandaryRegular, AppStyles.mt12, AppStyles.ml16,]}>{moment(item.pickup_date).format('DD-MMM-YY')}</Text>
      </View>
      ...
      <View style={[AppStyles.flexpointthree,]}>
       <Text style={[AppStyles.txtSecandaryRegular, AppStyles.f11, AppStyles.ml20,
              {

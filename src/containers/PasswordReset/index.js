...
function PasswordReset() {
  ...
  const loginForm = useFormik({
    ...
    validationSchema,
    onSubmit: () => passwordForgot(loginForm.values.username),
  });
      ...
      <View>
        <View style={[AppStyles.ml20, AppStyles.mt20]}>
          <TouchableOpacity onPress={() => screenNavigate()}>
            <Image source={require('../../assets/Images/ForgotPassword/LeftArrowIcon.png')} />
          </TouchableOpacity>
        </View>
        ...
        <View style={[AppStyles.alignCenter, AppStyles.mt40]}>
          <Text style={[AppStyles.txtWhiteBold, AppStyles.f40, AppStyles.pv10]}>Hello!</Text>
        </View>

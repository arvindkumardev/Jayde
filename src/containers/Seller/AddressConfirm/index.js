...
const AddressConfirm = () => {
  ...
  //     setEPRAggregatorName(pickerData);
  //   }
  // }, [aggregatorsData]);
  ...
  const businessForm = useFormik({
    ...
    onSubmit: () =>
    _addSchedule(
        businessForm.values.eprAggregatorId,
      ),
  });
    ...
    <View style={[AppStyles.flex1SpaceBetween, AppStyles.pb10, style.whitebackgrnd,]}>
      ...
      <View style={[AppStyles.mt20, AppStyles.w100]}>
        <View style={[AppStyles.w100, AppStyles.ph20, AppStyles.txtPrimaryBold]}>
          ...
          <View style={[AppStyles.mt20]}>
            <Text style={[AppStyles.txtBlackRegular, AppStyles.f15, AppStyles.mb6, AppStyles.ml5]}>Preferred EPR Partner: Raj</Text>
          </View>

        <View style={[AppStyles.mt20]}>
            <Text style={[AppStyles.txtBlackRegular, AppStyles.mb10, AppStyles.ml5, AppStyles.f15]}>EPR Aggregators</Text>
            <DropDown
